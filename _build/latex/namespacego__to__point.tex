...
\begin{DoxyVerb}Function for changing the robot's state.

Args:
    state(Int): the new state number    \end{DoxyVerb}
...
\begin{DoxyVerb}Function for '/odom' subscription callback.

Args:
    msg(Odometry): the current odometry of the robot.\end{DoxyVerb}
...
\begin{DoxyVerb}Function for setting all the robot's velocities to zero.\end{DoxyVerb}
...
\begin{DoxyVerb}Function for fixing the final yaw of the robot.

Args:
    des_yaw(Float): the target yaw.\end{DoxyVerb}
...
\begin{DoxyVerb}Function for fixing robot's yaw into the direction of the destination position.

Args:
    des_pos(Point): the destination position.\end{DoxyVerb}
...
\begin{DoxyVerb}Function to move the robot straight to the destination point.
...
\begin{DoxyVerb}Function to move the robot to a specific point.

Args:
    goal(PositionAction): PositionAction message which has the target position.\end{DoxyVerb}
...
\begin{DoxyVerb}main function for the node 'go_to_point'\end{DoxyVerb}
